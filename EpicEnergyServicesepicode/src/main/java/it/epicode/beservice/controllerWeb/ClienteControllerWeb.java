...
@Controller
@RequestMapping("/clientecontrollerweb")
public class ClienteControllerWeb {
	...
	@RequestMapping("/salvaclienteform")
		...
		@RequestMapping("/getclientibyfatturatoannualeform")
		...
		@RequestMapping("/getclientibydatainserimentoform")
		...
		@RequestMapping("/getclientebydataultimocontattoform")
		...
		@RequestMapping("/getclientebyragionesocialeparzialeform")
		...
		@RequestMapping("/selectlista/{lista}")
		...
		@RequestMapping("/selectregione/{nome}")
		...
		@RequestMapping("/selectprovincia/{nome}")
