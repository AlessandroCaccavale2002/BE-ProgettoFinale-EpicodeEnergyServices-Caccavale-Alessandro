...
public class PopolaDb implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Indirizzo i2 = new Indirizzo("Via Catania", 27, "98345", "Periferia", comune.getByNome("Givoletto").get());
		Indirizzo i3 = new Indirizzo("Via Primavera", 59, "95682", "Periferia", comune.getByNome("Monteu da Po").get());
		Indirizzo i4 = new Indirizzo("Via Autunno", 27, "87233", "Centro", comune.getByNome("Roure").get());
		Indirizzo i5 = new Indirizzo("Via Inverno", 150, "20050", "Periferia", comune.getByNome("Tavagnasco").get());
		Indirizzo i6 = new Indirizzo("Via Duomo", 175, "57020", "Centro", comune.getByNome("Moraro").get());
